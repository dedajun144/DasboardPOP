...
const Cover = (props) => {
  ...
  const getCoverById = async () => {
    try {
      ...
      setSideId(response.data.sideId);
      setTanggal(response.data.tanggal);
      setNamaSide(response.data.namaSide);
      setKoordinatSite(response.data.koordinatSite);
      setTipeSite(response.data.tipeSite);
      setModelSite(response.data.modelSite);
    } catch (error) {
      console.log(error);
    }
  };
