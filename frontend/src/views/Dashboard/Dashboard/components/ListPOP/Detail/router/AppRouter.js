    ...
    <BrowserRouter>
      <div className="container">
        ...
        <Switch>
          ...
          <Route render={(props) => <Kwh {...props} pm={pm} updatePM={updatePM} />} path="/kwh/:id" />
          <Route render={(props) => <Environtment {...props} pm={pm} updatePM={updatePM} resetPM={resetPM} />} path="/environtment/:id" /> */}
          <Route path="/kwh/:id" element={<Kwh />} />
          <Route path="/environtment/:id" element={<Kwh />} />
        </Switch>
